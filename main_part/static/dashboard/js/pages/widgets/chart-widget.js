...
function amChartGauge(){
	...
	brand          Axis.renderer.line.opacity = 0;
	brand          Axis.renderer.grid.template.disabled = true;
	brand          Axis.renderer.minGridDistance = 40;
	brand          Axis.dataFields.brand           = "year";
	brand          Axis.startLocation = 0.4;
	brand          Axis.endLocation = 0.6;
	...
	lineSeries.dataFields.brand          X = "year";
