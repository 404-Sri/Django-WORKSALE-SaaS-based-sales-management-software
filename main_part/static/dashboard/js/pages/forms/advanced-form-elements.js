...
function initImageSelect() {
  ...
  $("#imgsel").formSelect();
  var data = [
    { id: 1, name: "Option 1", url: "../../../static/dashboard/images/user/user1.jpg" },
    { id: 2, name: "Option 2", url: "../../../static/dashboard/images/user/user2.jpg" },
    { id: 3, name: "Option 3", url: "../../../static/dashboard/images/user/user3.jpg" }
  ];
