/**
 *  Document   : calenders.js
 *  Author     : redstar
 *  Description: Script for calenders data
 *
 **/
var Appcalenders = (function() {
  return {
    init: function() {
      this.initcalenders();
    },
    initcalenders: function() {
      if (jQuery().fullcalenders) {
        var d = new Date(),
          date = d.getDate(),
          month = d.getMonth(),
          year = d.getFullYear(),
          r = {};
        $("#calenders").removeClass("mobile"),
          (r = {
        ...
        $("#external-events div.external-event").each(function() {
          ...
          add("dinner"),
          add("party"),
          $("#calenders").fullcalenders("destroy"),
          $("#calenders").fullcalenders({
            header: r,
            defaultView: "month",
            slotMinutes: 15,
            editable: !0,
            ...
            drop: function(e, t) {
              ...
              (n.start = e),
                ...
                $("#calenders").fullcalenders("renderEvent", n, !0),
